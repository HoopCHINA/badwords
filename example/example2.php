...
function get_shared_badwords__() {
    ...
    $persistkey = 'badwords::com.foo.bar2::words';

    $compiler = badwords_compiler_create(BADWORDS_ENCODING_UTF8, True);
    badwords_compiler_append($compiler, "特朗普", "*和谐*");
    badwords_compiler_append($compiler, "希拉里", "*和谐*");
    badwords_compiler_append($compiler, 520, "*5*2*0");
